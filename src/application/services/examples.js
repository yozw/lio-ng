app.factory('examples', function () {
  ...
  return [
    ...
    {name: 'Chapter 4 (book)', subItems: [
      {name: 'Salmonnose', url: url('chapter04/salmonnose.mod')},
    ]},
    {name: 'Chapter 7 (book)', subItems: [
