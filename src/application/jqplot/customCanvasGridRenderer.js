// Class: $.jqplot.CustomCanvasGridRenderer
// This class is a copy of the default jqPlot grid renderer, creating a grid on a canvas element.
// The only difference is that it does not draw the top and right border.
$.jqplot.CustomCanvasGridRenderer = function () {
  this.shadowRenderer = new $.jqplot.ShadowRenderer();
};

// called with context of Grid object
$.jqplot.CustomCanvasGridRenderer.prototype.init = function (options) {
  this._ctx;
...
$.jqplot.CustomCanvasGridRenderer.prototype.createElement = function (plot) {
  var elem;
  // Memory Leaks patch
  if (this._elem) {
...
$.jqplot.CustomCanvasGridRenderer.prototype.draw = function () {
