...
(function($) {
  ...
  var locations = ['nw', 'n', 'ne', 'e', 'se', 's', 'sw', 'w', 'c'];
  var locationIndicies = {'nw':0, 'n':1, 'ne':2, 'e':3, 'se':4, 's':5, 'sw':6, 'w':7, 'c':8};
  var oppositeLocations = ['se', 's', 'sw', 'w', 'nw', 'n', 'ne', 'e', 'c'];
  ...
  $.jqplot.PointLabels.prototype.getActualWidth = function(elem, rotate) {
  ...
  $.jqplot.PointLabels.prototype.yOffset = function(elem, location, padding, rotate) {
    location = location || this.location;
    padding = padding || this.xpadding;
